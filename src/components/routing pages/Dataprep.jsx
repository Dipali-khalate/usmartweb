          ...
          <div className="row d-flex align-items-center">
            <div className="col-lg-6" id="conEle">
              <div className="hero-3-txt white-color">
                ...
                >
                  Build strategy for your complex problem
                </h2>
                <p
                  className="p-xl wow fadeInUp"
                  //   style="visibility: visible; animation-name: fadeInUp;"
                >
                  Transform strategies into solutions that help you make
                  data-driven decisions, deliver better solutions and conquer
            ...
            <div className="col-lg-6">
              ...
              >
                <img
                  ...
                  nitro-lazy-src="https://cdn-gehmn.nitrocdn.com/ejXDRhVMYwDqccVaEHuKASVAhgjQwSEv/assets/static/optimized/rev-2b297f9/wp-techknomatic/wp-content/themes/techknomatic/images/Tablet-Mockup-03.png"
                  class="img-fluid ls-is-cached lazyloaded"
                  nitro-lazy-empty=""
                  id="MjcyOjE2OQ==-1"
                  src="https://cdn-gehmn.nitrocdn.com/ejXDRhVMYwDqccVaEHuKASVAhgjQwSEv/assets/static/optimized/rev-2b297f9/wp-techknomatic/wp-content/themes/techknomatic/images/Tablet-Mockup-03.png"
                />
              </div>{" "}
            </div>{" "}
          </div>{" "}
          ...
          <div className="containerflex">
            ...
            <div className="image">
              ...
              <img
                ...
                nitro-lazy-src="https://cdn-gehmn.nitrocdn.com/ejXDRhVMYwDqccVaEHuKASVAhgjQwSEv/assets/static/optimized/rev-cd56d89/wp-techknomatic/wp-content/themes/techknomatic/images/strategy-consulting-2.png"
                class="img-fluid ls-is-cached lazyloaded"
                nitro-lazy-empty=""
                id="MjgxOjE3NQ==-1"
                src="https://cdn-gehmn.nitrocdn.com/ejXDRhVMYwDqccVaEHuKASVAhgjQwSEv/assets/static/optimized/rev-cd56d89/wp-techknomatic/wp-content/themes/techknomatic/images/strategy-consulting-2.png"
              ></img>
            </div>{" "}
            <div className="text">
              {" "}
              ...
              <p className="p-lg">
                Create business strategies & drive transformational changes
                throughout your organization to get accurate outcomes for your
                business problems.
                <br />
              </p>{" "}
              <p className="p-lg">
                We’ll help you find the right approach to meet your business
                goals, make strategic choices to accelerate performance and
                drive real changes.
              </p>{" "}
            </div>{" "}
          </div>{" "}
